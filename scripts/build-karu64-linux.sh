...
OUT_DIR="${OUT_DIR:-$PROJECT_ROOT/build/linux-riscv64-karu64}"
DEFCONFIG="${DEFCONFIG:-allnoconfig}"
FRAGMENT="${FRAGMENT:-$PROJECT_ROOT/configs/linux-riscv64-karu64-nfsroot.fragment}"
